...
def get_tts_response(text="テクノロジーで誰も取り残さない日本へ。テクノロジーで政治をかえる。あなたと一緒に未来をつくる。", voice_id=None, language="ja"):
    """
...
def generate_tts_pcm_bytes(text: str, voice_id: str = None, language: str = "ja") -> bytes:
    """
    テキストからPCM s16le形式の音声バイナリデータを生成する
